    ...
    <Card className={`${styles["cv-info-container"]} ${props.className}`}>
      <Section title="◖Profile">
        <p>
          ...
          languages fit into the bigger picture. I feel ready to and am
          enormously excited to get involved with a project or company. I am
          desperate to touch, to feel, to understand a real-world implementation
          of the skills which I have long wished I had been using ever since I
          left school.
        </p>
      </Section>
      ...
      <Section title="◖Projects">
        ...
        <Section title="uHost" className={styles.subsection}>
          <p>
            ...
            an online Javascript course on udemy.com. An application for users
            to search for recipes by keyword, modify the recipe ratios to their
            desired serving, create their own recipes (which are then pushed
            onto the external library), and bookmark favourites to be able to
            access them later. In this project I make use of many techniques
            including asynchronous Javascript, ES6 classes, and implementation
            of MVC architecture. This project marked a real step up in my
            approach to project implementation. Whether it be through a full
            analysis of which parts of the application are part of the model,
            the view, or the controller, or through making use of npm and
            external libraries, including bundlers, polyfillers, etc, the
            project pushed me to learn a range of skills. These skills opened my
            eyes to not just the processes needed to get a website up and
            running, but also to the hugh array of options available and
            possibilities to dive into. Visit: GitHub:
        ...
        <Section title="forkify" className={styles.subsection}>
          <p>
            ...
            as reactive design by making use of media queries. The application
            itself is a template of a server hosting service website. The design
            is very minimal and easy to navigate, demonstrating the use of
            transitions and animations to please the users eye and push the user
            towards CTAs. Visit: GitHub: github.com/williams-jacobr/uHost
          </p>
        </Section>
      </Section>
